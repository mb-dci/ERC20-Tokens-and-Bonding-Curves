...
contract tokenWithGodMode is ERC20("tokenWithGodMode", "TKG") {
    ...
    /**
     * Set the special address during deployment of the contract.
     */
    ...
    /**
     * @dev Setting a require before the super._update() function allows for the special
     * address transfer, transferFrom, mint, or burn to or from any address.
     */
